    ...
    var create = function (err, port) {
        ...
        if (typeof discoveryOptions !== 'boolean' || discoveryOptions) {
            ...
            self.discovery.on('added', function (obj) {
                ...
                onadded.call(self, obj.address + ":" + adv.port, false);
            });
        }

        self.nodesInterval = setInterval(function () {
            self.sock.send('connection::nodes::list', self.nodes);
        }, 10000);
        ...
        self.checkInterval = setInterval(function () {
            ...
            _.remove(self.nodes, function (n) { return (process.uptime() - n.when) > 600; });
            // CONTROLLARE I NODI NON COLLEGATI E COLLEGARLI
